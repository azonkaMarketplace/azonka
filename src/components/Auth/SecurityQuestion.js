                ...
                <div className="row">
                    ...
                    <div className="col-md-4 card" style={{padding:'15px 10px 15px 10px'}}>
                            ...
                            <div className="row">
                                <div className="col-md-12">
                                    <div className="form-group required-field">
                                        <label htmlFor="acc-name">Response</label>
                            ...
                            <div className="row">
                                <div className="col-md-12">
                                    <div className="form-group required-field">
                                        <label htmlFor="acc-name">Pincode</label>
                                        <input value={this.state.pincode} type="text"  name="pincode" onChange={this.handleInputChange}  className="form-control" required="" />
                                    </div>
                                </div>
